...
This has led to new analysis strategies that more carefully deal with the $N\pi$ excited state with pion-pole contributions \asm{and \change{additionally use the temporal axial current correlator to determine excited states.}}
%information about the excited states from the temporal axial current.}
