...
\iffalse
% includegraphics
\newcommand{\Umunu}{\hspace{-1.25in}\includegraphics[width=0.6\textwidth,valign=c]{plots/plaquette}\hspace{-0.65in}}
\fi
...
\scalebox{1.0}{
\begin{tikzpicture}
\draw[thick] (0,0) -- (\boxsize,0) -- (\boxsize,\boxsize) -- (0,\boxsize) -- cycle;
\draw[thick,-stealth] (       0,       0) -- (0.55*\boxsize,            0);
\draw[thick,-stealth] (\boxsize,       0) -- (     \boxsize,0.55*\boxsize);
\draw[thick,-stealth] (\boxsize,\boxsize) -- (0.45*\boxsize,     \boxsize);
\draw[thick,-stealth] (       0,\boxsize) -- (            0,0.45*\boxsize);
\node[anchor=north] at (       0.5*\boxsize ,    -\lbos*\boxsize ) {\small $U_\mu(x)$};
\node[anchor=west ] at ({(1+\lbos)*\boxsize},       0.5*\boxsize ) {\small $U_\nu(x+a\hat{\mu})$};
\node[anchor=south] at (       0.5*\boxsize ,{(1+\lbos)*\boxsize}) {\small $U^\dagger_\mu(x+a\hat{\nu})$};
\node[anchor=east ] at (    -\lbos*\boxsize ,       0.5*\boxsize ) {\small $U^\dagger_\nu(x)$};
\end{tikzpicture}
}
}
}
...
\begin{fmfgraph*}(50,40)
 ...
 \fmfleft{l0,l1}
 \fmfright{r0,r1}
 %% square box, with vertex placement for arrows
 \fmf{plain,tension=0.1}{l1,ml}
 \fmf{plain,tension=0.1}{l0,m0}
 \fmf{plain,tension=0.1}{r0,mr}
 \fmf{plain,tension=0.1}{r1,m1}
 \fmf{plain}{ml,l0}
 \fmf{plain}{m0,r0}
 \fmf{plain}{mr,r1}
 \fmf{plain}{m1,l1}
 ...
 \fmf{phantom,l.s=bottom,label=$U_\mu(x)$}{l0,r0}
 \fmf{phantom,l.s=left,label=$U_\nu(x+a\hat{\mu})$}{r1,r0}
 \fmf{phantom,l.d=4.0,l.s=top,label=$U^\dagger_\mu(x+a\hat{\nu})$}{r1,l1}
 \fmf{phantom,l.d=0.1,l.s=left,label=$U^\dagger_\nu(x)$}{l0,l1}
 %% arrows
 \fmf{fermion}{l1,ml}
 \fmf{fermion}{l0,m0}
 \fmf{fermion}{r0,mr}
...
\begin{marginnote}
\entry{Irrelevant operators}{In the renormalization sense, these are operators of mass dimension $[O]>4$, such that their dimensionful couplings scale as $a^n=\Lambda^{-n}$ where $\Lambda$ is a high energy scale
