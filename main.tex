...
baselines (L), both experiments sit at a similar L/E, probing similar oscillation physics.%
%-------------------------------------------------------------------------------
\begin{marginnote}
...
\change{Theoretical models which make different physical assumptions are typically used to model these, with {\it ad hoc} extrapolation to fill in gaps between the regions of validity of those models.}
