...
\end{marginnote}%---------------------------------------------------------------
Recently, a LQCD milestone was achieved when the nucleon axial coupling  was determined with a 1\% total uncertainty and a value consistent with experiment~\cite{Chang:2018uxx}.
...
\asm{systematic errors for the axial coupling, LQCD collaborations now focus on computing}
