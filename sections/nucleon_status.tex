...
\begin{marginnote}
 \entry{Axial charge} {The} axial form factor at zero momentum transfer, ($g_A = F_A(0)$)
\end{marginnote}
...
With proper control over the excited state contamination, the LQCD calculations are now in good agreement with the experimental value~\cite{Jang:2019vkm,Gupta:2018qil,Alexandrou:2020okk,Abramczyk:2019fnf,Park:2021ypf,RQCD:2019jai,Hasan:2019noy,Djukanovic:2021yqg,Harris:2019bih,Liang:2018pis,Shintani:2018ozy,Ishikawa:2018rew}
 with one group achieving a sub-percent determination of $g_A$~\cite{Chang:2018uxx,Berkowitz:2018gqe,Walker-Loud:2019cif}.

\done{Should we explicitly note again that this also fills a gap in the experimental program?}
Armed with the newfound confidence in the control of systematics for the axial charge,
 ...
 \new{to make contact with the needs of the neutrino community and provide
...
fall off of the form factor with increasing $Q^2$ than predicted by phenomenological determinations from experiment~\citeneeded.
...
over neutrino energies greater than $1~{\rm GeV}$~\citeneeded.
...
\asm{The \citeneeded are arguments made in this paper? Maybe just need section refs?}

The aforementioned situation with nucleon form factors is depicted in Figure~\ref{fig:nucleonxsec}.
{\color{gray}[Andre: would it be useful to make this paragraph a bullet list?]}
\new{
...
\end{description}}
\new{Of particular note} is the observed tension between the black and blue bands,
