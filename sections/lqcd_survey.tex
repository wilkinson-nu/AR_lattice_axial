...
As a rough estimate, the NME collaboration claims that the uncertainties are
 at least a factor of 5 larger if the fits are relaxed to allow for pion mass
 or lattice spacing effects.}
...
The published results use different lattice actions for the simulations ---
 ...
 use different ensembles of $O(a)$-improved Wilson clover fermions,
