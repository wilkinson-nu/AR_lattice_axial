...
\cw{HISQ seems like jargon that should be defined?}
...
Though the axial radius is useful for connecting with low-energy applications,
...
This is especially true considering the agreement between LQCD and experiment
 ...
 LQCD prefers a slower form factor fall off than experiment~\citeneeded.
...
\cw{I wonder if it's useful to highlight that the experimental data here is a small number of events from two old experiments? Whenever anything is contrasted with ``experiment'' I worry that it may not be clear to readers that the experiment is crap...}
...
Another concern to note is that the magnitude of $Q^2$ may adversely affect
