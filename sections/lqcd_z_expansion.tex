...
For the inverse transformation to take an expansion in $z$ to an expansion in $Q^2$,
 the expansion is again cast in terms of
\begin{equation}\label{eq:x_Q}
    x = \frac{Q^2+t_0}{t_c-t_0}\, ,
\end{equation}
...
For the axial form factor, $c_0 = \lim_{m_\pi\rightarrow0} g_A$, the nucleon axial charge in the chiral limit.
{\color{red}[map this out to $z^2$, deriving relation between $b_k$ and the LECs.  maybe comment about expressing $b_k$ as LECs and vice versa to test stability of the determination of LECs]}
