...
First, these methods enable the use of multi-hadron creation and annihilation operators
 \new{that are} essential to properly identify both the spectrum and the nature of the state~\cite{Dudek:2012xn,Lang:2012db},
...
\new{The} first efforts have been made to compute two-nucleon matrix elements in response to electroweak currents~\cite{Savage:2016kon,Chang:2017eiq}.
These calculations will most likely have to be revisited with a variational method as well,
 \new{since} it now appears the use of local two-nucleon creation operators do not correctly
